...
export async function getStaticProps({ params }: { params: any }) {
  try {
    ...
    const parameters = {
      ...
      //GA tiêu đề
      googleClientSlotId:"4907830482",
      //GA sau video
      googleAdSlot: "3594748811",
//Cái sau
      mgWidgetId1: "1874145",
      //Cái trước
      mgWidgetId2: "1874145",

      mgWidgetFeedId: "1874144",
      //scrip adkeeper
      adsKeeperSrc: "https://jsc.adskeeper.com/site/1057741.js",
      //Analytic
      googleTagId: "G-9330BVEZGQ",
    };
